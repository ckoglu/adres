...
<section>
  ...
  <pre class="json-highlight"><span class="json-key">fetch</span>(<span class="json-string">"https://adres.ckoglu.workers.dev/?api=[CMD]&key=[KEY]"</span>)
...
.<span class="json-key">catch</span>(<span class="json-number">err</span> <span class="json-equals">=></span> <span class="json-key">console</span>.<span class="json-key">error</span>(<span class="json-string">"hata:"</span>, <span class="json-number">err</span>));</pre>
  </section>`;

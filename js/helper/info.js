...
<section>
  ...
  <p>Tarayıcı url kutusuna <code>${url.site}${url.repository}?api=[KOMUT]&key=[UID]</code> yazarak veriye ulaşabilirsiniz. Örneğin: <a href="${url.site}${url.repository}?api=il=antalya&ilce=alanya&key=SENIN-UID" data-ust-title="Antalya ili ve Alanya İlçesi saf JSON çıktısı"><code>${url.site}${url.repository}?api=il=antalya&ilce=alanya&key=SENIN-UID</code></a></p>
  <h3 data-content="#" class="hover:content">fetch</h3>
  <div class="endpoint"><pre class="json-highlight"><span class="json-brace">(</span><span class="json-key">async</span> <span class="json-bracket">()</span> <span class="json-equals">=></span> <span class="json-brace">{</span>
  <span class="json-key">const</span> <span class="json-key">res</span> <span class="json-equals">=</span> <span class="json-key">await</span> <span class="json-key">fetch</span><span class="json-bracket">(</span><span class="json-quote">'</span><span class="json-string">https://script.google.com/macros/s/AKfycbw_MYcInMCCYiQZNzeaZAp7Upl_UwNZS2O1rlx1bDBwBT7UFJJPEpvNSSmbkCgWXATk/exec?site=</span><span class="json-quote">'</span> <span class="json-plus">+</span> <span class="json-key">encodeURIComponent</span><span class="json-bracket">(</span><span class="json-quote">'</span><span class="json-string">${url.site}${url.repository}?fetch=&lt;CMD&gt;</span><span class="json-quote">'</span><span class="json-bracket">)</span><span class="json-bracket">)</span><span class="json-semicolon">;</span>
  <span class="json-key">document</span>.<span class="json-key">body</span>.<span class="json-key">textContent</span> <span class="json-equals">=</span> <span class="json-key">await</span> <span class="json-key">res</span>.<span class="json-key">text</span><span class="json-bracket">(</span><span class="json-bracket">)</span><span class="json-semicolon">;</span>
<span class="json-brace">}</span><span class="json-bracket">)</span><span class="json-bracket">(</span><span class="json-bracket">)</span><span class="json-semicolon">;</span></pre></div>
  </section>`;
